...
a1, b1 = 1, 3
m1 = 100
resultat1 = trapeze(f1, a1, b1, m1)
exacte1 = (b1 ** 3 - a1 ** 3) / 3

print(f"Test 1 - f(x) = x² sur [{a1}, {b1}]")
print(f"Résultat trapèzes: {resultat1:.8f}")
...
a2, b2 = 0, np.pi
m2 = 100
resultat2 = trapeze(f2, a2, b2, m2)
exacte2 = 2.0  # ∫sin(x)dx de 0 à π = 2

print(f"Test 2 - f(x) = sin(x) sur [{a2}, {b2}]")
print(f"Résultat trapèzes: {resultat2:.8f}")
...
a3, b3 = 0, 1
m3 = 100
resultat3 = trapeze(f3, a3, b3, m3)
exacte3 = np.exp(1) - 1

print(f"Test 3 - f(x) = exp(x) sur [{a3}, {b3}]")
print(f"Résultat trapèzes: {resultat3:.8f}")
